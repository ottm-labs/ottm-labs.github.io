...
#### 토큰 발행(MINT)
요청 예시
* POST https://partner-api.ottm-dev.co/ramp/v1/nft/mint/:requestId
```json
  {
  "items": [
    {
...
요청 예시
* GET https://partner-api.ottm-dev.co/ramp/v1/nft/status/:requestId
...
요청 예시
* GET https://partner-api.ottm-dev.co/ramp/v1/nft/burn/:userId
...
요청 예시
* GET https://partner-api.ottm-dev.co/ramp/v1/nft/:userId
