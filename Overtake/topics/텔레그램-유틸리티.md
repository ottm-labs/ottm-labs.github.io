...
| 이름           | 타입      | 설명                                   | 예제 데이터                                                                                                      |
|--------------|---------|--------------------------------------|-------------------------------------------------------------------------------------------------------------|
| isValidUser  | String  | 유효한 initData 를 가진 사용자 여부             | true                                                                                                        |
...
#### Typescript
```typescript
window.overtake.utils.initialize("OVERTAKE_MINIAPP", "https://t.me/OvertakeMiniApp/app", (isValidUser: string, tgUserInfo: string | null, startParam: string | null) => console.log("initialized!"));
```

#### C#
```csharp
Action<string,string?,string?> onInitialized = delegate(string isValidUser, string? tgUserInfo, string? startParam)
{ 
